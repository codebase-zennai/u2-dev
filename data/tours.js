export const tours = [
  {
    ...
    "description": "Escape to the cooling mountain resort of Genting Highlands. Experience theme parks, shopping, and high-altitude entertainment.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Explore the UNESCO World Heritage Mulu Caves. Walk through massive chambers and hike the spectacular razor-sharp pinnacles.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Perfect family fun at Legoland and Desaru Coast. Discover historical heritage and delicious southern culinary delights.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Climb Mount Kinabalu, witness breathtaking peak sunrises, and relax on beautiful sandy islands of Sabah.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Marvel at the Petronas Twin Towers, explore ancient Batu Caves, and experience vibrant street food and shopping.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Relax on Cherating Beach, see the rainbow waterfalls of Sungai Lembing, and enjoy authentic seaside dining.",
    "featured": false,
    "destination": "Pahang, Malaysia",
  ...
  },
  {
    ...
    "description": "Duty-free shopping, cable car skybridge rides, and gorgeous sun-drenched beaches at this legendary archipelago.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Take a trishaw ride through historical Dutch Square, cruise Melaka River, and enjoy unique Nyonya cuisine.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Journey deep into Taman Negara, walk the canopy bridge, and witness rich tropical rainforest flora and fauna.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Voted top food city globally. Walk down historic Georgetown streets, visit Kek Lok Si Temple, and indulge in street food.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Discover cave temples, historical colonial structures, and sample famous Ipoh white coffee and local desserts.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Witness magical fireflies in Kuala Selangor, try white-water rafting, and explore the theme parks of Sunway Lagoon.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Unwind at the serene lakeside resort of Tasik Widuri. Great for boat tours, fishing, and peaceful retreats.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Ride camels in the Arabian desert, visit the Burj Khalifa observation deck, and explore grand shopping malls.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Experience the romance of Paris, the historic Colosseum of Rome, and the spectacular snowcapped Swiss Alps.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Marvel at the majestic Taj Mahal in Agra, explore Jaipur's Pink City palaces, and experience bustling Old Delhi.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Tour historic temples in Ubud, walk on volcanic black beaches, and witness stunning seaside cliff sunsets.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Explore historic palaces in Seoul, shop in Myeongdong, and experience the beautiful cherry blossoms of Jeju Island.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Hike near Pokhara lake, see Mount Everest ranges, and tour ancient temples in the historic city of Kathmandu.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Go on big-game safaris at Kruger National Park and ride the cableway to the summit of Table Mountain.",
    "featured": false,
  ...
  },
  {
    ...
    "description": "Explore Bangkok's grand palaces and reclining Buddhas, then relax on the world-class beaches of Phuket.",
    "featured": true,
  ...
  },
  {
    ...
    "description": "Cruise through thousands of limestone islands in Halong Bay and walk heritage streets of Hanoi.",
    "featured": false,
  ...
  },
  {
    ...
    "accommodation": "N/A",
    "meals": "N/A",
    "transport": "Guided Vehicle",
    "itinerary": [{ "day": 1, "title": "Sightseeing", "desc": "Enjoy a guided sightseeing tour with hotel pick-up and drop-off." }]
  },
  {
    "id": 17,
