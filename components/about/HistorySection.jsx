...
const historyItems = [
  {
    year: "2008",
    description:
      "U2 Travels was born on 27th November under Executive Director K. Jai Kishen",
  },
  {
    year: "2010",
    description:
      "Expanded inbound tour operations across all major Malaysian destinations",
  },
  {
    year: "2015",
    description:
      "Launched world tour packages covering 9+ countries including Europe, Korea & Dubai",
  },
  {
    year: "2020",
    description:
      "60+ years collective management experience, serving groups from 2 to 500+ travelers",
  },
];
          ...
          <div className="wrap_flex is-align-top">
            ...
            <div className="max-width-440 is-full-responsive">
              <div className="text-color-lightgrey">
                ...
                >
                  The current management team has a collective experience of
                  over 60 years in the travel & service industry. We are
                  aggressively concentrating our efforts in promoting inbound
                  tours to Malaysia — from cool hill stations and sunny beaches
                  to lush green forest reserves and much more. U2 Travels can
