    ...
    <li className="tours_item">
      ...
      <div className="w-layout-vflex flex-grow flex flex-col justify-between mt-4">
        <div className="w-layout-vflex">
          ...
          <p className="text-size-regular text-color-darkgrey margin-bottom-24">{tour.description}</p>
        </div>
        <div className="mt-auto">
          <Link href="/about-us" className="button is-secondary w-full text-center">
            <p>View Itinerary</p>
          </Link>
        </div>
      </div>
